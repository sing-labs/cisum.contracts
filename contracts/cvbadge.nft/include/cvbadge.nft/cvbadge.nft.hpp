...
#include <cvbadge.nft/cvbadge.nft.db.hpp>
 ...
 */
class [[eosio::contract("cvbadge.nft")]] cvbadge : public contract {
   public:
      using contract::contract;

   cvbadge(eosio::name receiver, eosio::name code, datastream<const char*> ds): contract(receiver, code, ds),
   ...
   using transfer_action = action_wrapper< "transfer"_n, &cvbadge::transfer >;
