...
namespace eosio {
   ...
   using std::string;
   static constexpr eosio::name POH_MINTER = "poh.cisum"_n;
   static constexpr eosio::name POS_MINTER = "pos.cisum"_n;
   static constexpr eosio::name POP_MINTER = "pop.cisum"_n;
   /**
