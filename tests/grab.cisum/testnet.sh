...
mpush grab.cisum setrushsale '["myadmin",11,20,3000,null]' -p myadmin


mpush nestar.token transfer '["flonian","grab.cisum","6000.0000 SONG","grab:13:a1799ae8e1ea62a20a5f56710342a228"]' -p flonian
