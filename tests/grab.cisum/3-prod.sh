...
mpush $grab_con addupgrade '["flonian",1760855632324,2101025077573,"2025-10-20T00:00:00","2025-11-20T00:00:00",{ "amount": 1, "symbol": { "nid": "2101025919776" } },10,5000]' -p flonian

mpush ticket.cvnft transfer '["flonian","grab.cisum",[{"amount":1,"symbol":{"nid":2101025921799}}],"rushupgrade:1:a1799ae8e1ea72a20a5f57710352a123"]' -p flonian
...
show_con=show.cisum
mpush $show_con issuetograb '["show.cisum","grab.cisum", {"amount":100,"symbol":{"nid":'2101025077573'}}, "addrushupgrade:2:1760855632324"]' -p $show_con
